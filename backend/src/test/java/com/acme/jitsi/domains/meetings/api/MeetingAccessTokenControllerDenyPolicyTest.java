...
@SpringBootTest(
    properties = {
      ...
      "app.meetings.token.unknown-role-policy=deny-access",
...
class MeetingAccessTokenControllerDenyPolicyTest {

  @Autowired
  private MockMvc mockMvc;

  @Test
  void missingRoleClaimWithDenyPolicyReturnsAccessDenied() throws Exception {
