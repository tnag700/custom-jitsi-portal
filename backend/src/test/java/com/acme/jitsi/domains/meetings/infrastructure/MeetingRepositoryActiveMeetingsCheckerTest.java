...
class MeetingRepositoryActiveMeetingsCheckerTest {
  ...
  void hasActiveOrFutureMeetings_withMoreThanHundredMeetings_usesExistsQuery() {
    ...
    MeetingRepositoryActiveMeetingsChecker checker =
        new MeetingRepositoryActiveMeetingsChecker(meetingRepository, fixedClock, 120);
